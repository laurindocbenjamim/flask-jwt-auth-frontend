...
import {
    ...
    HardDrive, Download, Info, MoreVertical, Trash2, Star, Clock, Users, Share2, LogOut
} from 'lucide-react';
                ...
                <div className="px-2 mb-6">
                    <div className="bg-gray-200/50 dark:bg-gray-700/50 p-1 rounded-xl flex">
                        <button
                            ...
                            className="flex-1 flex items-center justify-center gap-2 py-2 rounded-lg text-sm font-medium transition-all text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200"
                        >
                            <Cloud className="h-4 w-4" /> Google
                        </button>
                        <button
                            className="flex-1 flex items-center justify-center gap-2 py-2 rounded-lg text-sm font-medium transition-all bg-white dark:bg-gray-600  dark:text-white text-blue-800 shadow-sm"
                        >
