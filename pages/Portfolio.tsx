...
import { Briefcase, Code, User, ExternalLink, Calendar } from 'lucide-react';
      ...
      <div className="bg-white shadow overflow-hidden sm:rounded-lg max-w-3xl mx-auto">
        <div className="px-4 py-5 sm:px-6 flex items-center">
            ...
            <div>
                ...
                <p className="mt-1 max-w-2xl text-sm text-gray-500">Passionate about building scalable web applications.</p>
            </div>
        </div>
        <div className="border-t border-gray-200 px-4 py-5 sm:p-0">
          <dl className="sm:divide-y sm:divide-gray-200">
            <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">Laurindo C. Benjamim</dd>
            </div>
            <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            ...
            <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">Portugal</dd>
            </div>
            <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
