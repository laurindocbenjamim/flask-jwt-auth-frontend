            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  ...
                  <span className="block text-primary-600 xl:inline">for Modern Apps</span>
                </h1>
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  A complete starter kit featuring JWT authentication, Role-Based Access Control, and a modern React frontend connected to a robust Flask backend.
                </p>
            ...
            <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              <div className="relative">
                <dt>
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">JWT Authentication</p>
                </dt>
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Secure stateless authentication using JSON Web Tokens. Includes token revocation and blocklisting capabilities.
                </dd>
              </div>
              ...
              <div className="relative">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Comprehensive dashboard for administrators to manage users, view system stats, and handle access.
                </dd>
              </div>
              ...
              <div className="relative">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Full CRUD operations for user profiles. Users can register, update their details, and manage their account.
                </dd>
              </div>
              ...
              <div className="relative">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Integrated Google Sign-In support for fast and easy onboarding using social credentials.
                </dd>
              </div>
            </dl>
          </div>
